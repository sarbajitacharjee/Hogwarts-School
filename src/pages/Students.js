    ...
    <section className="student-life mb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-8">
        <div className="flex-1 bg-white p-6 rounded-lg shadow-lg mb-6 lg:mb-0">
          <img src='./images/extra.jpg' alt='Extracurricular Activities' className="w-full h-64 object-cover rounded-lg mb-4"/>
        ...
        <div className="flex-1 bg-white p-6 rounded-lg shadow-lg">
          <img src='./images/clubs.png' alt='Clubs and Societies' className="w-full h-64  mb-4"/>
    ...
    <section className="achievements mb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="achievement bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <img src='./images/award.jpeg' alt='National Science Fair Winner' className="w-full h-40 object-cover rounded-lg mb-4"/>
        ...
        {/* Example Achievement */}
        <div className="achievement bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <img src='./images/gold.jpg' alt='Art Competition Gold Medal' className="w-full h-40 object-cover rounded-lg mb-4"/>
        ...
        {/* Example Achievement */}
        <div className="achievement bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <img src='./images/sports.webp' alt='Top Sports Performer' className="w-full h-40 object-cover rounded-lg mb-4"/>
